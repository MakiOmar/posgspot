...
class WoocommerceServiceProvider extends ServiceProvider
{
    ...
    protected function registerCommands()
    {
        $this->commands([
            ...
            \Modules\Woocommerce\Console\RetryStaffNoteUpdate::class,
        ]);
    }
            ...
            foreach ($businesses as $business) {
                ...
                if (!empty($api_settings->enable_auto_sync)) {
                    ...
                    $this->app->booted(function () use ($business) {
                        ...
                        $schedule->command('pos:WoocommerceSyncProducts ' . $business->id)->everyFiveMinutes(1, 13);
                        $schedule->command('pos:WooCommerceSyncOrder ' . $business->id)->everyFiveMinutes(1, 13);
                    });
                }
            }
        }
