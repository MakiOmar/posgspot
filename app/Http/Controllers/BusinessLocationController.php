...
class BusinessLocationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $input = $request->only(['name', 'landmark', 'storefront_address', 'city', 'state', 'country', 'zip_code', 'invoice_scheme_id',
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $input = $request->only(['name', 'landmark', 'storefront_address', 'city', 'state', 'country',
