...
| POST | `/digital/reviews` | Proxy Accounts public review submit — body `{ phone, stars: 1–5, comment?, game_id? \| card_category_id? }` (exactly one target). Reviews stay pending until Accounts admin approves. 503 when digital catalog off. |
