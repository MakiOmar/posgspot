...
return [
    ...
    'username' => 'Username',
    'password' => 'Password',
    'storefront_password' => 'Storefront password',
    'storefront_password_confirmation' => 'Confirm storefront password',
    'storefront_password_help' => 'Optional. Sets the password used on the web shop and mobile app (min 8 characters).',
    'storefront_password_help_edit' => 'Leave blank to keep the current password. Min 8 characters when setting a new one.',
    ...
    'coupon_discount_amount_help' => 'For percentage type: enter the percent (e.g. 10 for 10%). For fixed type: enter the amount to subtract from the eligible subtotal.',
    'coupon_max_discount_help' => 'Optional cap for percentage coupons. The discount will not exceed this amount even if the percent would be higher.',
    'coupon_min_subtotal_help' => 'Minimum eligible cart subtotal required before the code can be applied (after scope and sale-item rules).',
    'coupon_channel_help' => 'Storefront: online shop only (v1). POS: in-store later. Both: shared code when POS redemption is enabled.',
    'coupon_applies_to_help' => 'Entire cart, or only lines in selected categories or product variations.',
    'coupon_categories_help' => 'When scope is categories, only cart lines in these categories count toward eligibility and discount.',
    'coupon_products_help' => 'When scope is products, only these variations count toward eligibility and discount.',
    'coupon_starts_at_help' => 'Optional. Code is not valid before this date and time.',
    'coupon_ends_at_help' => 'Optional. Code expires after this date and time.',
    'coupon_max_uses_total_help' => 'Optional global limit across all customers. Leave empty for unlimited uses.',
    'coupon_max_uses_per_customer_help' => 'Optional per-customer limit. Requires the shopper to be signed in at checkout.',
    'coupon_active_help' => 'Inactive codes cannot be applied on the storefront.',
    'coupon_first_order_only_help' => 'Only customers with no previous completed storefront orders can use this code. Sign-in required.',
    'coupon_exclude_sale_help' => 'Lines already on a storefront sale price are excluded from the eligible subtotal.',
    'coupon_stack_reward_points_help' => 'When unchecked, reward points cannot be redeemed on the same order as this code.',
    ...
    'adjust_reward_points' => 'Adjust Reward Points',
    'adjustment_type' => 'Adjustment Type',
    'credit_reward_points' => 'Add / Credit points',
    'debit_reward_points' => 'Remove / Debit points',
    'points' => 'Points',
    'reward_points_adjusted' => 'Reward points adjusted',
    'reward_points_adjusted_success' => 'Reward points updated successfully',
    'reward_points_not_enabled' => 'Reward points are not enabled for this business',
    'cannot_adjust_walk_in_reward_points' => 'Cannot adjust reward points for walk-in customer',
    'reward_points_insufficient' => 'Customer only has :points points available',
    'reward_points_credited_note' => 'Credited :points :name (balance :before → :after)',
    'reward_points_debited_note' => 'Debited :points :name (balance :before → :after)',
    ...
    'test_email_address_is_required' => 'Test email address is required',
    'test_email_look' => 'Test email appearance',
    'test_email_look_help' => 'Send a sample email to preview how your emails look with the current settings and watermark.',
    'test_email_subject' => ':business - Test Email',
    'test_email_sample_heading' => 'Sample notification email',
    'test_email_sample_body' => 'This is a preview of how your notification emails will appear to customers.',
    'test_email_sample_footer' => 'This is a test email from :business.',
    'view_invoice' => 'View invoice',
    'email_watermark_settings' => 'Email watermark settings',
    'enable_email_watermark' => 'Enable watermark on emails',
    'email_watermark_type' => 'Watermark type',
    'email_watermark_business_name' => 'Business name',
    'email_watermark_logo' => 'Business logo',
    'email_watermark_logo_help' => 'Upload a business logo in Business settings to use it as the watermark.',
    ...
    'product_gallery_help' => 'Optional extra images for the storefront product page. When set, these replace the default single-image gallery. Pick from the media library or upload files directly.',
    'product_gallery_from_library' => 'From media library',
    ...
    'so_invoice_on_full_payment' => 'Invoice sales order only when fully paid',
    ...
    'sales_order_location_id_help' => 'Business location to use for sales orders when location lock is enabled.',
    'sales_order_location_lock_roles' => 'Roles for Sales Order Location Lock',
    'sales_order_location_lock_roles_help' => 'Select which roles should have the sales order location locked.',
