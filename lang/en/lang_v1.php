...
return [
    ...
    'lock_sales_order_location_help' => 'When enabled, the location is auto-selected and cannot be changed when creating a sales order.',
    'sales_order_location_id' => 'Sales Order Location',
    'sales_order_location_id_help' => 'Business location ID to use for sales orders when location lock is enabled.',
