            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        {!! Form::textarea('storefront_address', $location->storefront_address, ['class' => 'form-control', 'rows' => 2, 'placeholder' => __( 'lang_v1.storefront_display_address_help' ) ]); !!}
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('show_on_storefront', 1, (bool) ($location->show_on_storefront ?? true), ['id' => 'show_on_storefront']); !!}
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        {!! Form::text('latitude', $location->latitude, ['class' => 'form-control', 'placeholder' => '30.0444', 'step' => 'any']); !!}
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        {!! Form::label('longitude', __( 'lang_v1.longitude' ) . ':') !!}
                        {!! Form::text('longitude', $location->longitude, ['class' => 'form-control', 'placeholder' => '31.2357', 'step' => 'any']); !!}
                    </div>
                </div>
                <div class="clearfix"></div>
                <div class="col-sm-6">
