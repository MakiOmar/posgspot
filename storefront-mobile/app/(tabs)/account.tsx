  ...
  return (
    <Screen>
      ...
      <View style={styles.langRow}>
        <Pressable
          style={[styles.lang, locale === "en" && { backgroundColor: accent }]}
          onPress={() => setLocale("en")}
        >
          <Text style={locale === "en" ? styles.langActive : undefined}>EN</Text>
        </Pressable>
        <Pressable
          style={[styles.lang, locale === "ar" && { backgroundColor: accent }]}
      ...
      {!token ? (
        <>
          <Link href="/login" asChild>
            <PrimaryButton label={t("common.login")} onPress={() => undefined} />
          </Link>
        ...
        <>
          <Link href="/account/orders" asChild>
            <PrimaryButton label={t("common.orders")} onPress={() => undefined} />
          </Link>
          <View style={{ height: 10 }} />
          ...
          <View style={{ height: 10 }} />
          <PrimaryButton label={t("common.logout")} onPress={() => void signOut()} />
        </>
      )}
