...
export const ABOUT_CONTENT_AR: AboutPageContent = {
  ...
  historyIntro:
    "فروعنا أكثر من مجرد مساحات بيع—هي مراكز للحماس والتواصل والاكتشاف لكل محبي الألعاب. صُمم كل موقع لمجتمع الألعاب، بمزيج من الطابع العصري والسحر الكلاسيكي لخلق أجواء مرحّبة.",
  teamTitle: "فريقنا",
  team: [
